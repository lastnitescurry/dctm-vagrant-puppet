...
# for examples
echo "$(date) - bashrc - documentum - user"

# Puppet - Will need
alias puppy='sudo puppet apply --modulepath /vagrant/puppet/modules /vagrant/puppet/manifests/site.pp'

echo "$(date) - bashrc - oracle - configure"
if [ -f /u01/app/oracle/product/11.2.0/xe/bin/oracle_env.sh ]; then
  . /u01/app/oracle/product/11.2.0/xe/bin/oracle_env.sh
  alias sqlm='$ORACLE_HOME/bin/sqlplus system/manager@$ORACLE_SID'
